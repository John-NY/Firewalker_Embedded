...
megaSerialClass::~megaSerialClass()
{

}

void megaSerialClass::handleReadyRead()
{
//    m_standardOutput << ",";
...
void megaSerialClass::handleBytesWritten(qint64 bytes)
{
...
void megaSerialClass::handleReaderTimeout()
{
//    m_standardOutput << ",";
...
void megaSerialClass::ProcessSerialReceived()
{
    int start = -1;
    int end = -1;
...
void megaSerialClass::handleError(QSerialPort::SerialPortError serialPortError)
{
...
void megaSerialClass::write(const QByteArray &writeData)
{
...
void megaSerialClass::requestTelemetry()
{
    write("|T|");
}

void megaSerialClass::startReaderTimer()
{
//    m_timer.start(100);
    handleReaderTimeout();
}
